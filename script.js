document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        const formGroups = contactForm.querySelectorAll('.form-group, .input-group');
        
        function showError(input, message) {
            const formGroup = input.closest('.form-group') || input.closest('.input-group') || input.parentElement;
        ...
        function validateField(input) {
            ...
            if (input.tagName === 'TEXTAREA' && value !== '' && input.hasAttribute('minlength')) {
                const minLength = parseInt(input.getAttribute('minlength'));
                if (value.length < minLength) {
                    showError(input, `Minimum ${minLength} characters required`);
                    return false;
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; background: #d4edda; border-radius: 4px; text-align: center;';
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; background: #f8d7da; border-radius: 4px; text-align: center;';
    ...
    const animatedElements = document.querySelectorAll('.fade-in, .animate, [data-animate]');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '793f133a-9070-4d77-b216-a73dad1a274b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '793f133a-9070-4d77-b216-a73dad1a274b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '793f133a-9070-4d77-b216-a73dad1a274b';
